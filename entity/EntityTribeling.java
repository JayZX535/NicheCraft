package com.niche.nichecraft.entity;

import com.google.common.base.Predicate;
import com.niche.nichecraft.entity.ai.EntityAIBegTribeling;
import com.niche.nichecraft.entity.ai.EntityAIMateTribeling;
import com.niche.nichecraft.entity.ai.EntityAINestTribeling;
...
public class EntityTribeling extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityTribeling.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityTribeling.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityTribeling.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> GENDER = EntityDataManager.<Integer>createKey(EntityTribeling.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> PREGNANT = EntityDataManager.<Boolean>createKey(EntityTribeling.class, DataSerializers.BOOLEAN);
    ...
    public EntityTribeling(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(6, new EntityAINestTribeling(this, 0.8D));
        this.tasks.addTask(6, new EntityAIMateTribeling(this, 1.0D));
        this.tasks.addTask(7, new EntityAIWander(this, 1.0D));
        this.tasks.addTask(8, new EntityAIBegTribeling(this, 8.0F));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        //boolean flag = false;
        int i = this.chooseRandomGender();
        this.setGender(i);
        this.setPregnant(false);
        System.out.println("Gender set to " + i);
        System.out.println("Pregnant set to " + this.isPregnant());
        return livingdata;
    }

    private int chooseRandomGender()
    {
    ...
    /**
     * Determines whether this wolf is male or female.
     */
    public int getGender()
    {
        return (((Integer)this.dataManager.get(GENDER)).intValue());
    }

    /**
     * Sets whether this wolf is male or female.
     */
    public void setGender(int gender)
    {
    	this.dataManager.set(GENDER, Integer.valueOf(gender));
    }
    
    /**
     * Determines whether this wolf is pregnant or not.
     */
    ...
    public void setPregnant(boolean pregnant)
    {
    	if (pregnant == true)
    	{
    		this.dataManager.set(PREGNANT, true);
    	}
    	else
    	{
    		this.dataManager.set(PREGNANT, false);
    	}
    }
    ...
    public EntityTribeling createChild(EntityAgeable ageable)
    {
        EntityTribeling EntityTribeling = new EntityTribeling(this.worldObj);
        UUID uuid = this.getOwnerId();

        if (uuid != null)
        {
            EntityTribeling.setOwnerId(uuid);
            EntityTribeling.setTamed(true);
        }
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityTribeling))
        {
            return false;
        }
        else
        {
            EntityTribeling EntityTribeling = (EntityTribeling)otherAnimal;
            if (EntityTribeling.getGender() != this.getGender())
            {
            return !EntityTribeling.isTamed() ? false : (EntityTribeling.isSitting() ? false : this.isInLove() && EntityTribeling.isInLove());
            }
            else
            {
            	return false;
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof EntityTribeling)
            {
                EntityTribeling EntityTribeling = (EntityTribeling)p_142018_1_;

                if (EntityTribeling.isTamed() && EntityTribeling.getOwner() == p_142018_2_)
                {
                    return false;
                }
            }
