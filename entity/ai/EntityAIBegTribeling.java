...
public class EntityAIBegTribeling extends EntityAIBase
{
    private final EntityTribeling theWolf;
    private EntityPlayer thePlayer;
    private final World worldObject;
    private final float minPlayerDistance;
    private int timeoutCounter;

    public EntityAIBegTribeling(EntityTribeling wolf, float minDistance)
    {
        this.theWolf = wolf;
